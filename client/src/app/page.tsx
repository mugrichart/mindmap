      ...
      <main className="relative z-10 mx-auto flex max-w-7xl flex-col items-center px-6 pt-24 pb-32 sm:px-12 lg:pt-32">
        ...
        <nav className="fixed top-6 left-1/2 flex w-[90%] max-w-4xl -translate-x-1/2 items-center justify-between rounded-full bg-card/60 px-6 py-3 backdrop-blur-xl border border-white/5 shadow-2xl">
          <div className="flex items-center gap-2">
            <div className="h-8 w-8 rounded-lg bg-primary glow-blue flex items-center justify-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <button className="rounded-full bg-primary px-5 py-2 text-sm font-semibold text-white transition-all hover:scale-105 active:scale-95 glow-blue">
              Get Started
            </button>
          </div>
        </nav>
        ...
        <section className="flex flex-col items-center text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/5 px-4 py-1 text-sm font-medium text-primary">
            ...
            Private Beta for Curated Learners
          </div>

          <h1 className="mt-8 max-w-4xl text-5xl font-extrabold leading-[1.1] text-heading sm:text-7xl">
            Where your thoughts <br /> find their <span className="text-gradient">rightful place</span>.
          </h1>
          ...
          <div className="mt-12 flex flex-col gap-4 sm:flex-row">
            <button className="group relative flex items-center gap-2 rounded-full bg-primary px-8 py-4 text-lg font-bold text-white transition-all hover:scale-105 active:scale-95 glow-blue">
              Start Mapping
